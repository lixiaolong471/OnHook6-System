function fixTable(container) {
  ...
  function relayout() {
    ...
    ths.forEach(function(th, i) {
      ...
      // console.log(33, thStyles[i].width + 'px');
      if (i === 0) {
 ...
 //window.addEventListener('resize', resizeThrottler, false);
  ...
  container.addEventListener('scroll', function() {
      ...
      thead.style.msTransform = 'translate3d(0,' + this.scrollTop + 'px,0)';
      thead.style.MozTransform = 'translate3d(0,' + this.scrollTop + 'px,0)';
      thead.style.OTransform  = 'translate3d(0,' + this.scrollTop + 'px,0)';
      thead.style.webkitTransform    = 'translate3d(0,' + this.scrollTop + 'px,0)';
      var hTransform = 'translate3d(' + this.scrollLeft + 'px,0,0)';
      thead.querySelector('th').style.transform = hTransform;
      thead.querySelector('th').style.msTransform = hTransform;
      thead.querySelector('th').style.MozTransform = hTransform;
      thead.querySelector('th').style.OTransform  = hTransform;
      thead.querySelector('th').style.webkitTransform  = hTransform;
    [].slice.call(tbody.querySelectorAll('tr > td:first-child'))
      .forEach(function(td, i) {
          td.style.transform = hTransform;
          td.style.msTransform = hTransform;
          td.style.MozTransform = hTransform;
          td.style.OTransform  = hTransform;
          td.style.webkitTransform = hTransform;
      });
  });
