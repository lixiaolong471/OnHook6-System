                ...
                link: function ($scope, $element, $attrs, ngModel) {
                    ...
                    ngModel.$render = function () {
                        ...
                        if (!ngModel.$viewValue && currentDate) {
                            ...
                            if (!moment.isMoment(ngModel.$viewValue)) {
                                ngModel.$setViewValue(moment(ngModel.$viewValue).format($scope.options.format));
                            }
                            console.log(123456,ngModel.$viewValue);
                    ...
                    dpElement.on('dp.change', function (e) {
                        if (!isDateEqual(e.date, ngModel.$viewValue)) {
                            ...
                            if(newValue){
                                ngModel.$setViewValue(new moment(newValue).format($scope.options.format));
                            } else {
